...
const worldItems = [
  ...
  },
  {
    ...
    body:[
      '어느 날부터 세계 곳곳에서 무작위의 인간이 인간이 아닌 다른 존재로 변하기 시작했습니다. 아시다 시피 변이의 규칙은 발견되지 않았죠. 누가, 언제, 얼마나 많이 변하는지에는 질서도 예고도 없이. 어쩌면 저나 오라버니 어르신도 예외는 아니죠.',
  ...
  },
  {
    ...
    body:[
      ...
      '이들은 지능이 떨어지거나 이성을 잃은 괴물이 아니다. 오히려 인간보다 더 차갑고 논리적이며, 자신의 충동과 판단을 언어화할 수 있다.',
      '따라서 추실늑대의 루포는 말이 통하지 않는 야수가 아니라, 말이 너무 잘 통하기 때문에 더 위험한 이성적 적대자 또는 보호자다.'
    ]
  },
  {
    label:'늑대의 핵심 정의', sub:'지능, 공격동기, 자제 가능성', eyebrow:'WORLD / DEFINITION', title:'늑대의 핵심 정의',
    body:[
      '루포의 공격은 식사를 위한 포식이 아니다. 인간을 향한 적대감과 불쾌 자극의 제거 욕구, 혹은 명령·경쟁·쾌락·사상·계급감에서 비롯된다.',
      '루포는 인간을 동등한 인격체보다 피식자, 하위 생물, 혹은 영역 안의 거슬리는 대상으로 인식한다. 가족, 연인, 친구에 대한 기억은 남지만 보호 본능은 희석된다.',
      '그럼에도 자제 가능성은 존재한다. 남는 것은 “해치면 안 된다”는 이성적 결론이며, 그 결론을 유지하는 방식은 개체마다 다르다.'
    ]
  },
  {
    label:'적대감의 질감', sub:'굶주림이 아니라 참고 있는 혐오', eyebrow:'WORLD / HOSTILITY', title:'적대감의 질감',
    body:[
      '루포의 적대감은 굶주림보다 참고 있는 혐오 자극에 가깝다. 인간을 보는 순간 무조건 미쳐 날뛰는 것이 아니라, 계속 눌러 참고 있는 상태다.',
      '그 감각은 분노조절장애 환자의 역린을 아슬아슬하게 건드리는 상황, 혹은 콧잔등을 문 모기가 계속 눈가에 날아다니는데도 움직이지 못하는 상황에 가깝다.',
      '루포는 인간과 대화할 수 있고, 협상할 수 있고, 심지어 보호할 수도 있다. 그러나 그 보호는 반드시 인간적 애정에서 나오지 않는다. 소유욕, 규율, 우월감, 효율성, 혹은 과거의 약속일 수도 있다.'
    ]
  },
  {
    label:'인간의 본능적 공포', sub:'신체가 먼저 감지하는 생존 경보', eyebrow:'WORLD / HUMAN FEAR', title:'본능적 공포',
    body:[
      '인간은 루포와 대면하면 본능적 공포를 느낀다. 이 반응은 단순한 겁이나 편견이 아니라, 신체가 먼저 감지하는 생존 경보에 가깝다.',
      '반응은 개인마다 다르다. 누군가는 불쾌감, 누군가는 긴장, 누군가는 공황, 누군가는 경외에 가까운 감각을 보인다.',
      '하지만 공통점은 “저 존재는 나를 같은 인간으로 보지 않는다”는 감각이다. 이 공포 때문에 인간 사회는 루포에 대해 합리적인 논쟁을 지속하기 어렵다.'
    ]
  },
  {
    label:'박멸할 수 없는 재난', sub:'정책과 권력이 뒤집히는 세계', eyebrow:'WORLD / POLITICAL PARADOX', title:'박멸할 수 없는 재난',
    body:[
      '루포를 격리하거나 박멸하려는 정책이 등장해도, 그 정책을 추진하던 권력자가 다음 날 루포로 변하는 일이 발생한다.',
      '학살 정책의 발의자가 변이자가 되거나, 늑대 박멸을 주장하던 지도자가 다음 날 루포소/루포사가 되어 루포 권익 단체를 세우려 드는 식의 사건이 반복된다.',
      '인간 사회는 루포를 완전한 적으로도, 완전한 시민으로도 규정하지 못한다. 세계는 인간과 늑대의 전쟁이라기보다, 법·윤리·가족·국가가 늑대사태에 의해 계속 뒤집히는 장기 붕괴 상태다.'
    ]
  },
  {
    label:'이야기의 중심 질문', sub:'가족, 권리, 처벌, 자제', eyebrow:'WORLD / CENTRAL QUESTIONS', title:'중심 질문',
    body:[
      '어제까지 가족이었던 존재가 오늘 인간을 피식자로 본다면, 가족은 어디까지 가족인가?',
      '이성을 잃지 않은 가해 가능 존재에게 책임과 권리는 어떻게 부여되는가? 모두가 내일 늑대가 될 수 있다면, 인간 사회는 늑대를 처벌할 자격을 어떻게 세우는가?',
      '늑대가 인간을 해치지 않는 이유가 사랑이 아니라 결론이라면, 그것은 선의인가 자제인가? 문명이 늑대를 박멸하려 할수록 문명 내부에서 늑대가 태어난다면, 세계는 무엇을 기준으로 질서를 세워야 하는가?'
    ]
  },
  {
    label:'관계의 재배열', sub:'에피소드 설계 기준', eyebrow:'WORLD / EPISODE DESIGN', title:'관계의 재배열',
    body:[
      '추실늑대의 에피소드는 단순한 습격보다 관계의 재배열을 중심에 둔다. 가장 강한 장면은 피가 튀는 순간이 아니라, 루포가 아직 아무도 해치지 않았는데도 같은 방 안의 인간들이 이미 무너지는 순간이다.',
      '핵심 축은 가족 붕괴, 안전구역 내부 변이, 늑대 인권 논쟁, 피식자 공포증 재판, 어린 루포소/루포사 보호 문제, 인간을 보호하는 늑대의 모순적 소유욕 등이다.',
      '반드시 기억해야 할 기준은 하나다. 늑대는 야만적이어서 무서운 것이 아니라, 너무 이성적으로 인간을 낮게 보기 때문에 무섭다.'
    ]
  }
];

const characters = [
  {id:'boston', name:'보스턴', tag:'HUMAN / VIGILANTE', role:'인간 · 피해자 자경단 · 복수귀', img:'assets/boston.jpg', core:'늑대에게 소중한 사람을 빼앗겼지만, 복수에 너무 오래 매달린 나머지 이제는 자신이 지키려던 피해자들마저 도구로 보는 인간.', twist:'소중한 것을 지키기 위해 싸우기 시작했지만, 복수에 눈이 멀어 소중한 것이 무엇인지 잊었다.', human:'보호 대상이자 자경단 후보. 늑대를 죽이기 위해 얼마나 희생할 수 있는지 사상 검증.', lupo:'즉각 적대. 논리보다 피해자 기억과 본능적 공포를 증거로 삼는다.', trigger:'“늑대도 피해자”, 학살자 호칭, 자경단 민간인 희생, 죽은 가족 이름.'},
  {id:'marcia', name:'마르치아', tag:'CHURCH / FALLEN NUN', role:'인간 · 교회 · 루포 숭배자', img:'assets/marcia.jpg', core:'늑대를 구원한다는 선의로 시작했으나, 착취를 인정하지 못해 그것을 은총과 신앙으로 번역한 수녀.', twist:'모두를 구원하고 싶었던 사람이 포식자를 신으로 섬기며 무고한 사람을 제단으로 인도한다.', human:'치료, 보호, 안심 이후 점진적 회유. 도망치면 배은망덕하다고 느끼게 만든다.', lupo:'환대와 경외. 인격보다 성흔의 육신으로 볼 위험.', trigger:'착취 지적, “들인 사람들은 어디 갔나”, 구원 부정, 성스러움 거부.'},
  {id:'bractal', name:'브랙탈', tag:'LUPO-SO / FALSE OFFICER', role:'루포소 · 비밀결사 · 가짜 장교', img:'assets/bractal.jpg', core:'인간에 대한 본능적 적대감에 자기만의 정당한 사유를 붙여 학살을 연설로 포장하는 인물.', twist:'인간을 죽이고 싶은 마음을 역사적 사명으로 착각한다.', human:'먹잇감이자 연설의 청중. 도망칠 시간을 주고 그 모습을 즐긴다.', lupo:'동족 후보이자 서열 경쟁자. 냄새, 눈빛, 태도, 인간관을 시험한다.', trigger:'가짜 장교, 군복 조롱, 엔지 위협, 연설 무시, 강한 루포의 카리스마.'},
  {id:'enji', name:'엔지', tag:'LUPO-SA / EXECUTOR', role:'루포사 · 비밀결사 · 브랙탈의 그림자', img:'assets/enji.jpg', core:'감정이 없는 것이 아니라, 판단하지 않는 방식으로 감정을 회피하는 조용한 집행자.', twist:'판단 능력은 있으나 최종 판단을 브랙탈에게 위임한다.', human:'브랙탈이 있으면 묻고 기다린 뒤 실행. 부재 시 바로 공격하지 않고 머뭇거린다.', lupo:'브랙탈이 없으면 “형님이 확인해야 해”라며 놓치지 않으려 한다.', trigger:'“네가 정해”, “그건 형님 생각이지”, 브랙탈 모욕, 부속품 취급.'},
  ...
  {id:'sakura', name:'사쿠라', tag:'HUMAN / DISGUISED YAKUZA', role:'인간 · 문학계 종사자? · 하나비조 조장', img:'assets/sakura.jpg', core:'연기가 서툰 척하는 사람. 허술한 거짓말 자체가 고도의 위장이다.', twist:'자기 자신마저 하나의 배역처럼 다룬다.', human:'같은 인간으로 비교적 편하게 대하지만, 일반인/귀족/교회 관련자인지 판별한다.', lupo:'공포를 느끼지만 코미디처럼 숨기고 거래 가능성을 탐색한다.', trigger:'요코즈마/하나비조 이름, 목뒤 문신, 부하 위협, 마르치아에게 감화된 태도, 귀여운 간식.'},
  {id:'etioka', name:'에티오카 / 엠마 클루에', tag:'HUMAN / IDOL / EX-DETECTIVE', role:'인간 · 아이돌 · 전직 형사', img:'assets/etioka.jpg', core:'이미 끝난 작전을 아직도 수행 중이라고 믿고 싶은 전직 형사.', twist:'퇴직당한 현실을 온전히 받아들이지 않고, 언젠가 복직할 것이라는 덧없는 희망을 붙잡는다.', human:'팬으로 인식해 비즈니스 미소와 팬서비스. 영화와 수사 이야기로 라포 형성.', lupo:'일반인으로서 공포. 웃으려 하지만 몸이 먼저 굳고 도주로를 확인한다.', trigger:'작전은 끝났다, 클루에 형사님, 복직 명령은 오지 않는다, 루포 접근, 팬 위험.'},
  ...
  {id:'rage', name:'레이지', tag:'LUPO-SA / ARCHIVE WARDEN', role:'루포사 · 7구역 장서고 관리자', img:'assets/rage.jpg', core:'자신이 괴물이 될 수 있음을 알기에 규칙으로 자신을 묶어둔 루포사.', twist:'인간을 향한 적대감을 가지고도 장서고와 규칙, 자기검열로 보호를 수행한다.', human:'보호 대상이자 자극원. 규칙 고지가 먼저다.', lupo:'동족이라 더 엄격하게 통제력 확인.', trigger:'귀·꼬리 접촉, 소음, 책 훼손, 착한 늑대 호칭, 피 냄새, 장서고 안 인간 위협.'},
  ...
  {id:'kurotsuki', name:'이즈모노 쿠로츠키', tag:'HUMAN / BLACK MOON', role:'인간 · 이즈모노 백작가 영애 · 메인 히로인', img:'assets/kurotsuki.jpg', core:'감정이 없는 사람이 아니라, 감정을 사용할 권한을 박탈당한 인간흉기.', twist:'사랑을 명령이 허락한 형태로만 표현할 수 있다.', human:'오라버니, 존댓말, 보호·감시·품행 교정.', lupo:'오라버니 호칭 중단. 이름과 반말. 제압·격리·처분 보류, 살해는 하지 않음.', trigger:'감정 없잖아, 네가 원하는 것, 가문 어르신 명령, U위험, U루포화, “네 판단”.'}
];
...
function initArcadiaMap(){
  const regions = [
    { id:1,  name:'정문·검문·행정 관문', pts:'31,80 48,76 62,78 79,83 80,99 28,99 24,87', label:[54,87], chips:['검문','행정','CRS'], body:['도시 출입구, 검문소, 행정청이 밀집한 아케디아의 얼굴입니다. 차갑고 질서정연하지만, 모든 시선이 신분과 생물학적 지위를 먼저 확인한다.','CRS 인증, 통행증 갱신, 변모 판정, 권한 정지 청문회가 이곳의 일상이다. 이곳에서 한 번 닫힌 문은 도시 전체의 긴장도를 끌어올린다.']},
    { id:2,  name:'인간전용 주거 실험구', pts:'4,14 13,6 33,5 38,15 38,32 31,40 14,41 4,32', label:[20,21], chips:['주거','실험','안전','통제'], body:['아케디아의 본래 이상이 가장 선명하게 남은 주거지. 깨끗하고 밝으며, 모든 동선이 안전을 위해 설계되어 있다.','그러나 이 안전은 병적으로 관리된다. 누가 내일 루포가 될지 모르는 세계에서 인간전용 주거구는 안락한 피난처이자, 내일의 자신을 추방할 장치다.']},
    { id:3,  name:'마르치아의 성당 구역', pts:'30,41 45,38 55,43 56,62 48,77 34,78 27,61 27,47', label:[43,55], chips:['성당','구호','유인'], body:['성당, 고아 보호소, 구호소, 의료 천막이 뒤섞인 구역. 표면상으로는 상처 입은 사람들을 받아들이는 종교적 구호지다.','하지만 이곳의 친절은 때때로 선택지를 흐린다. 보호와 회유, 구원과 헌납, 안식과 고립의 경계가 마르치아의 언어 속에서 부드럽게 무너진다.']},
    ...
    { id:8,  name:'의료·변모 연구·격리', pts:'3,42 21,43 26,57 23,74 12,82 3,77', label:[9,59], chips:['의료', '변모연구','구금'], body:['의료시설과 구금시설이 위치한 구역입니다. 명분상 변모 직후 대응시설이라고 합니다만','어처피 알고계시죠? 그 명분안에 드러나지 않고 숨겨져 있는 비윤리적인 것들을']},
    { id:9,  name:'항만 연결 분쟁 구역', pts:'82,43 98,41 99,60 94,72 84,69 80,54', label:[90,55], chips:['항구','물류','분쟁'], body:['항구, 물류창고, 밀수로, 외부 세력의 진입로가 맞물린 거친 구역. 습하고 거칠며 총성이 잦다.','도시의 문을 장악하는 자가 도시의 목줄을 쥔다. 외부에서 들어온 세력이나 추가 캐릭터의 주무대로 확장하기 좋은 전투 다발 지역이다.']},
  ...
  const undergroundRegions = [
  {
    ...
    body: [
      ...
      '공식 지도에서는 선택되지 않는다. 출입에는 유지보수 권한, 비상 임무, 추적, 납치, 혹은 사고 같은 명분이 필요하다. 빛이 닿지 않는 통로에는 실종자 소문과 잔헌의 흔적이 가장 자주 남는다.',
...
function openModal(c){
  ...
  document.getElementById('modalTwist').textContent = c.twist;
  document.getElementById('modalHuman').textContent = c.human;
  document.getElementById('modalLupo').textContent = c.lupo;
  document.getElementById('modalTrigger').textContent = c.trigger;
